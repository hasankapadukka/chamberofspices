...
export const Leadership = () => {
    ...
    const governanceStructure = [
        { q: "Governing Board", icon: Shield, a: "The supreme decision-making body of the Chamber, composed of industry veterans, elected officials, and key stakeholders representing the interests of Ceylon Spices." },
